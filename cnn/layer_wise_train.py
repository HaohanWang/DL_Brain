...
def evaluate_lenet5(learning_rate=0.05, n_epochs=30,
                    dataset='mnist.pkl.gz',
                    nkerns=None, batch_size=500):
    ...
    #     rng,
    #     input=layer0.output,
    #     image_shape=(batch_size, 20, 28, 14),
    #     filter_shape=(50, 20, 5, 3),
    #     poolsize=(2, 2),
    #     convDropRate = -1
    # )
    ...
    #     rng,
    #     input=layer1.output,
    #     image_shape=(batch_size, 50, 12, 6),
    #     filter_shape=(100, 50, 5, 3),
    #     poolsize=(2, 2),
    #     convDropRate = -1
    # )
    ...
    # layer2_input = layer4.output.flatten(2)
    ...
    layer3 = LogisticRegression(input=layer0.output.flatten(2), n_in=3740, n_out=2)
    ...
    learning_rates = [0.005, 0.005, 0.25, 0.25]
    reg_rate = [0.5, 0.5, 3, 3]
    ...
    save_object(best_params, '../model/firstLayer.pkl')


if __name__ == '__main__':
    evaluate_lenet5()
    # params = pickle.load(open('../model/firstLayer.pkl'))
    # ms = []
    # for param in params:
    #     ms.append(param.get_value(True))
    # for m in ms:
    #     print m.shape, m